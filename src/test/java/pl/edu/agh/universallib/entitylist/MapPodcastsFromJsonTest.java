...
public class MapPodcastsFromJsonTest {
	...
	@Test
	public void testMapFromJson() throws EntityException {
		List<Entity> testResults = podcastList.mapEntities(json);
		assertTrue(testResults.size() == 2);
	}

	@Test(expected = EntityException.class)
	public void testMalformedJson() throws EntityException {
		podcastList.mapEntities("This is not a JSON string");
	}
