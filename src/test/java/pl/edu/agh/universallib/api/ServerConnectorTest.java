...
public class ServerConnectorTest {
	...
	public void testProcess() {
		...
		System.out.println(serverConnector.getApiCalls().get(apiCall).getData());
		assertFalse(serverConnector.getApiCalls().get(apiCall).getData().isEmpty());
	}

	@Test
	public void testGetApiCalls() {
		assertTrue(serverConnector.getApiCalls().isEmpty());
	}
